...
def predict():
    ...
    return render_template('index.html', 
                           profit_line_html=fig1.to_html(full_html=False), 
                           profit_per_city_line_html=fig2.to_html(full_html=False),
                           profit_per_city_pie_html=fig3.to_html(full_html=False))
